	 ...
	 <div class="form-group" id = divEnterprise>
      ...
      <div class="col-sm-5">
         <select name="enterprise" class="form-control" id="enterprise" name = "enterprise"
            ...
            <option value="2">Chucoding</option>
            ...
            <option value="9">Firefox</option>
            <option value="10">Melon</option>
            <option value="11">Kakao</option>
            <option value="12">Naver</option>
            <option value="13">Google</option>
            <option value="14">Facebook</option>
            <option value="15">Instagram</option>
            <option value="16">Twitter</option>
            <option value="17">시나공</option>
            <option value="18">VisualStudio</option>
         </select>
      </div>
   </div>
