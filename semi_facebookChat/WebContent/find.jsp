...
<script type="text/javascript">
	...
	function getFriend(findID){
		$('#friendResult').html('<thead>'+
				...
				'<tbody>'+
				'<tr>'+
				'<td style="text-align:center;"><h3>'+findID+'</h3><a href="chat.jsp?toID='+encodeURIComponent(findID)+'"style="background-color:lightgray; color:white;" class="btn btn-lignt pull-right">'+
				'메시지 보내기</a></td>'+
				'</tr>'+
				'</tbody>');
	}
	...
	<div class="container">
		<table class="table table-bordered table-hover" style="text-align:center; border:1px solid #dddddd">
			...
			<tbody>
				...
				<tr>
					<td colspan="2"><button class="btn btn-lignt pull-right" onclick="findFunction();">검색</button></td>
				</tr>
			</tbody>
		</table>
	</div>
			...
			<div class="modal-dialog vertical-align-center">
				<div
					...
					<div class="modal-footer">
						<button type="button" class="btn btn-lignt" data-dismiss="modal">확인</button>
					</div>
				</div>
			</div>
		</div>
