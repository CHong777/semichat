      ...
      <form method="post" action="./UserRegisterServlet">
         <table class="table table-bordered table-hover" style="text-align: center; border: 1px solid #dddddd">
            ...
            <tbody>
               ...
               <td style="width: 110px;"><button class="btn btn-light" onclick="registerCheckFunction();" type="button">중복체크</button></td>
               </tr>
               <tr>
               ...
               <tr>
               	 <td style="text-align : left;" colspan="3"><h5 style="color:red;" id="passwordCheckMessage"></h5>
               	 	<input class="btn btn-light pull-right" type="submit" value="등록"/>
               	 </td>
               </tr>
            </tbody>
         </table>   
